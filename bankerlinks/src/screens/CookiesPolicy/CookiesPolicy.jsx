...
const CookiesPolicy = () => {
  return (
    <div className='policy-container'>
      ...
      <p>
        Login related cookiesWe use cookies when you are logged in so that we can remember this fact. 
      ...
      <p>
        Site preferences cookiesIn order to provide you with a great experience on this site we provide the functionality to set your preferences for how this site runs when you use it. 
      ...
      <p>
        ...
        For these to work the following social media sites including FaceBook, LinkedIn, will set cookies through our site which may be used to enhance your profile on their site or contribute to the data they hold for various purposes outlined in their respective privacy policies.
      </p>
