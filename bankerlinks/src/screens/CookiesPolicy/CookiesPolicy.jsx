...
const CookiesPolicy = () => {
  return (
    <div className='policy-container'>
      <h2>BankerLinks Cookies Policy</h2>
      ...
      <p>
        For more general information on cookies, see the <a href="https://en.wikipedia.org/wiki/HTTP_cookie" target="_blank" rel="noopener noreferrer">Wikipedia article on HTTP Cookies</a>.
      </p>

      <h4>How We Use Cookies</h4>
      <p>
        We use cookies for a variety of reasons detailed below. Unfortunately, in most cases, there are no industry-standard options for disabling cookies without completely disabling the functionality and features they add to this site. 
        It is recommended that you leave all cookies on if you are not sure whether you need them or not, in case they are used to provide a service that you use.
      </p>
      ...
      <ul>
        <li>
          ...
          For more information on Google Analytics cookies, see the official <a href="https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage" target="_blank" rel="noopener noreferrer">Google Analytics page</a>.
        </li>
        <li>
          - The Google AdSense service we use to serve advertising uses a DoubleClick cookie to serve more relevant ads across the web and limit the number of times that a given ad is shown to you. 
          For more information on Google AdSense, see the official <a href="https://support.google.com/adsense/answer/2839090?hl=en" target="_blank" rel="noopener noreferrer">Google AdSense privacy FAQ</a>.
        </li>
        <li>
          ...
          For these to work, the social media sites will set cookies through our site which may be used to enhance your profile on their site or contribute to the data they hold for various purposes outlined in their respective privacy policies.
        </li>
      </ul>

      <h4>More Information</h4>
      <p>
        Hopefully, this has clarified things for you, and as was previously mentioned, if there is something that you aren’t sure whether you need or not, it’s usually safer to leave cookies enabled in case they interact with one of the features you use on our site.
      </p>
      <p>
