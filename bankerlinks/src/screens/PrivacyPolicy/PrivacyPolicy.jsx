...
const PrivacyPolicy = () => {
  return (
    <div className='policy-container'>
      <h2>BankerLinks Privacy Policy</h2>
      <p><strong>Last updated:</strong> March 05, 2021</p>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          to BankerLinks s.à.r.l., 9, rue du Laboratoire – L- 1911 Luxembourg.
        </li>
        <li>
        ...
        <li>
          - <strong>Website</strong> refers to BankerLinks WebSite, accessible from
          <a href="https://www.bankerlinks.com"> https://www.bankerlinks.com</a> or <a href="http://www.bankerlinks.lu"> http://www.bankerlinks.lu</a>.
        </li>
      ...
      <p>
        ...
        Usage Data may include information such as Your Device’s Internet Protocol address (e.g., IP address), browser type, browser version, the pages of our Service
      ...
      <ul>
        <li>- By phone number: +352 621 405 208</li>
        <li>- By e-mail through our dedicated contact page.</li>
      </ul>
    </div>
  );
};
